...
cmake -DCMAKE_BUILD_TYPE=Debug "-DCMAKE_MAKE_PROGRAM=C:\Program Files\JetBrains\CLion 2024.2.0.1\bin\ninja\win\x64\ninja.exe" -G Ninja -S $p0 -B $p1
cmake --build $p1 --target vcu_core -j 18
